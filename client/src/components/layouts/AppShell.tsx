...
const mainNavItems: NavItem[] = [
  ...
  { label: "WhatsApp Simulator", href: "/whatsapp-simulator", icon: <MessageSquare className="w-5 h-5" /> },
...
export function AppShell({ children }: AppShellProps) {
  ...
  const routePermissions: Record<string, string[]> = {
    ...
    "/whatsapp-simulator": ["admin", "manager", "waiter", "kitchen", "delivery", "customer"],
